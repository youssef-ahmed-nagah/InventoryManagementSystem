...
namespace ClassLibrary1.Migrations
{
    ...
    [Migration("20230221175446_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryManagementSystem.InventoryCategoty", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryManagementSystem.ReturnProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryManagementSystem.InventoryCategoty", b =>
                {
                    b.HasOne("InventoryManagementSystem.Category", "Category")
                        .WithMany("InventoryCategoties")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryManagementSystem.Inventory", "Inventory")
                        .WithMany("InventoryCategotygories")
                        .HasForeignKey("InventoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InventoryManagementSystem.Category", b =>
                {
                    b.Navigation("InventoryCategoties");
            ...
            modelBuilder.Entity("InventoryManagementSystem.Inventory", b =>
                {
                    ...
                    b.Navigation("InventoryCategotygories");
